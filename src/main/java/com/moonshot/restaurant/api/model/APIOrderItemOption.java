...
public class APIOrderItemOption {
	private Long menuItemOptionId;
	private String name;
	private String description;
	private float price;
	private String currency;
	public APIOrderItemOption() {
		super();
		// TODO Auto-generated constructor stub
	}

	public APIOrderItemOption(Long menuItemOption, String name, String description, float price, String currency) {
		super();
